        ...
        <div class="items">
            <ul class="grid-view">
                <li class="item profile">
                    <a href="profile/{{ $profile->id}}" class="top">
                ...
                <li class="item">
                    <a href="progress/{{ $profile->progress->id }}" class="top">
                ...
                <li class="item notice">
                    <a href="/noticeboard/{{ $profile->classroom->id }}" class="top">
                ...
                <li class="item schedule">
                    <a href="/bill-record/{{ $profile->id }}" class="top">
                ...
                <li class="item chat">
                    <a href="/schedule/{{ $profile->classroom->id }}" class="top">
