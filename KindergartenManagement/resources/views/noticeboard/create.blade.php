...
@section('content')
    ...
    <div class="center">
        <div class="card w-fit">
            <div class="card-header text-bg-primary title-header"> Post Notice </div>
                    ...
                    <div class="card-body" >
                        <form method="POST" action="/notice" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div id="selected-class" class="col-md-5 class-list">
                                    @foreach($classrooms as $classroom)
                                        @if(old('class-'.explode(' / ', $classroom->classroom_name)[0].explode(' / ', $classroom->classroom_name)[1]))
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="">
                                    <textarea id="message" type="text"
                                              ...
                                              name="message" autofocus>{{ old('message') }}</textarea>
                            ...
                            <div class="row mb-3">
                                <label for="upload-file" class="col-form-label mx-2"> Upload
                                    File </label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="dropdown col-md-6 w-100">
                                    <label class="w-100">
                                        <select id="status"
                                                class="form-control text-center dropdown-input w-100 @error('status') is-invalid @enderror"
                            ...
                            <div class="row mb-3">
                                <label for="expired_date" class="col-form-label">Expire
                                    Date</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 logo-center">
                                    @php
                                        $returnTo = (auth()->user()->role = 'teacher') ? '/noticeboard/'.auth()->user()->staff->teacher->classroom->id: '/noticeboard'
                                    @endphp
                                    <a href="{{ $returnTo }}" class="btn btn-dark mb-2">
                                        Cancel
                                    </a>
                                </div>
                                <div class="col-md-6 logo-center">
